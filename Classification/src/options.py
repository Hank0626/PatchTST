...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--data_dir', default='/data1/guohang/dataset/Timedataset/EthanolConcentration',
                                 help='Data directory')
        ...
        self.parser.add_argument('--name', dest='experiment_name', default='EthanolConcentration',
        ...
        self.parser.add_argument('--records_file', default='Classification_records.xls ',
        ...
        self.parser.add_argument('--val_pattern', type=str,default='TEST',
        ...
        # lora
        self.parser.add_argument('--r', default=8)
        self.parser.add_argument('--lora_alpha', default=32)
        self.parser.add_argument('--lora_dropout', default=0.1)

        # others
        self.parser.add_argument('--word_embedding_path', type=str, default="wte_pca_500.pt")
