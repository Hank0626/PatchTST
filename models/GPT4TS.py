...
class GPT4TS(nn.Module):
    ...
    def forward(self, x, itr):
        ...
        intermidiate_feat_time = tuple([self.time_proj(feat) for feat in list(intermidiate_feat_time)])
        intermidiate_feat_text = tuple([self.text_proj(feat) for feat in list(intermidiate_feat_text)])
