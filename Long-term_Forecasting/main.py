...
parser.add_argument('--root_path', type=str, default='/data1/guohang/dataset/all_six_datasets/ETT-small')
parser.add_argument('--data_path', type=str, default='ETTh2.csv')
parser.add_argument('--data', type=str, default='ett_h')
