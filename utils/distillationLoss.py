...
class DistillationLoss(nn.Module):
    def __init__(self,args):
        ...
        self.loss_weight = nn.Parameter(torch.tensor([1., 1.]))
    ...
    def forward(self, outputs, batch_y):
        ...
        total_loss = self.loss_weight[0] * nn.L1Loss()(outputs_time, batch_y) + self.loss_weight[1] * logits_loss + 0.01 * feature_loss
        return total_loss
